...
const fetchIssues = () => {
    ...
    document.getElementById('remainIssue').innerText = openIssue;
    document.getElementById('closedIssue').innerText = closedIssue;
    document.getElementById('totalIssue').innerText = openIssue + closedIssue;
